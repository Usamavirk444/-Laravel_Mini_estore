                ...
                <div class="owl-menu-item owl-carousel">
                    ...
                    @foreach ($data as $item)
                        ...
                        <form action="{{url('addcart',$item->id)}}" method="post">
                            @csrf
                    <div class="item">
                        <div style="background-image: url({{asset('admin/food/'.$item->img)}})" class='card card1'>
                            <div class="price">
                                <h6>${{$item->price}}</h6>
                            </div>
                            <div class='info'>
                        ...
                        <input type="number" name="quality" min= "1" value="1" style="width: 130px">
                        <input type="submit" value="Add cart" class="btn btn-sm btn-success">
                    </div>
                </form>
                    @endforeach
                ...
                <div class="col-lg-4">
                    <div class="chef-item">
                        <div class="thumb">
                            ...
                            <img src="{{asset('admin/chef/'.$chef->chefImage)}}" alt="Chef #1">
                        </div>
                        ...
                        <form id="contact" action="{{url('reservation')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <fieldset>
                                        <input name="rname" type="text" id="name" placeholder="Your Name*" required="">
                                    </fieldset>
                                </div>
                                <div class="col-lg-6 col-sm-12">
                                    <fieldset>
                                        <input name="remail" type="text" id="email" pattern="[^ @]*@[^ @]*"
                                            placeholder="Your Email Address" required="">
                                    </fieldset>
                                </div>
                                <div class="col-lg-6 col-sm-12">
                                    <fieldset>
                                        <input name="rphone" type="text" id="phone" placeholder="Phone Number*"
                                            required="">
                                    </fieldset>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <fieldset>
                                        <input name="guest" type="number" id="phone" placeholder="Guest Number"
                                        required="">
                                    </fieldset>
                                </div>
                                <div class="col-lg-6">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <fieldset>
                                        <input name="time" type="time" id="phone" placeholder="Time"
                                            required="">
                                    </fieldset>
                                </div>
                                <div class="col-lg-12">
