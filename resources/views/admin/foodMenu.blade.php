            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="insertFood" method="post" enctype="multipart/form-data" class="forms-sample">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="fdes" class="form-control" placeholder="Descripition">
                            </div>
