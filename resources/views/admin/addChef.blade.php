            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="insertChef" method="post" enctype="multipart/form-data" class="forms-sample">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="cspeciality" class="form-control" placeholder="Price">
                            </div>
                            <div class="form-group">
